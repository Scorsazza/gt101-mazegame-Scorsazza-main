...
class MyASGEGame(pyasge.ASGEGame):
    ...
    def __init__(self, settings: pyasge.GameSettings):
        ...
        self.data.game_map = GameMap(self.renderer, "./data/map/Maze.tmx")
        ...
        self.data.player = pyasge.Sprite()

        self.data.player.loadTexture("/data/textures/player.png")
        # setup the background and load the fonts for the game
        self.init_audio()
        self.init_cursor()
        self.init_fonts()
        self.data.player.width = 40
        self.data.player.height = 40
        self.player_position = pyasge.Point2D(150, 150)
        self.data.player.x = 110
        self.data.player.y = 110
        player_x = self.data.player.x
        player_y = self.data.player.y
        self.data.player.z_order =50
    ...
    def render(self, game_time: pyasge.GameTime) -> None:
        ...
        self.renderer.render(self.data.player)
